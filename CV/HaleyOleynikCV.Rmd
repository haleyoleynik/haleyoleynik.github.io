...
- Used empirical harbour seal diet data and modeled diets from Ecopath with Ecospace ecosystem models to statistically validate model outputs and inform field sampling programs

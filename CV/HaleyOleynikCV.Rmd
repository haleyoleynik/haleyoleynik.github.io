...
* Multifactor, multistock analysis of salmon and steelhead population dynamics in British Columbia and a retrospective analysis of ecological and socioeconomic conditions in these fisheries
* Population modeling to identify drivers of productivity declines in Fraser River salmon populations, with the goal of furthering understanding of regional, multi-species population patterns, and identifying ecological and anthropogenic drivers of salmon population decline
- *Skills: Statistical modeling, Bayesian modeling, R programming, Git/Github, stakeholder engagement*

**Research Analyst** \hfill Feb 2026 - Present

*Pacific Salmon Commission*  Vancouver, B.C.

- Analyze salmon monitoring data to statistically evaluate the use of a new monitoring method for salmon passage through Hells Gate, a narrow gorge which poses passage challenges for salmon migrating up the Fraser River to their spawning grounds
...
**Teaching Assistant** \hfill Sept 2023 - December 2025
...
*"Impacts of Dam Operations on Mortality and Injury of Juvenile Chinook Salmon at Cougar Dam"* Willamette Science Review \hfill March 2026
